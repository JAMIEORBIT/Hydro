getgenv().key = "aj0MDeuO" --  you can make this anything that you want



if not isfolder("aj0MDeuO Key") then

    makefolder("aj0MDeuO Key")
    writefile("aj0MDeuO Key/key.txt", "enter key")
end
...
co1:CreateButton("Sorting Tab", function ()
        ...
        if game.Players.LocalPlayer.PlayerGui:FindFirstChild("Mush") then
            game.Players.LocalPlayer.PlayerGui:FindFirstChild("Mush"):Destroy()
        end
    else
